...
int main(){
  ...
  string fileName = "spot_sphere.scn";
  ...
  while( fgets(line,1024,fp) ) { //Assumes no line is longer than 1024 characters!
    ...
    //spot_light 0 .5 0 1 0 1 0 1 2 45 90
      ...
      float r,g,b,px,py,pz,dx,dy,dz,angle1,angle2;
       ...
       lights.push_back(new Spotlight(r*255, g*255, b*255, px,py,pz,dx,dy,dz,angle1,angle2));
    }
    //point_light 10 10 10 0 5 0
      ...
      float r,g,b,x,y,z;
       ...
       lights.push_back(new Pointlight(r*255,g*255,b*255,x,y,z));
    }
      ...
      float r,g,b,x,y,z;
       ...
       lights.push_back(new DirectionLight(r,g,b,x,y,z));
    }
  ...
  picture.ConstructrayThroughPixel(c,sce,lights);
